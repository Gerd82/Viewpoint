  ...
  module EWS
    module ItemFieldUriMap
      ...
      FIELD_URIS= {
        ...
        :physical_addresses_street            => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:Street', :writable => true},
        :physical_addresses_city              => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:City', :writable => true},
        :physical_addresses_state             => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:State', :writable => true},
        :physical_addresses_postal_code       => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:PostalCode', :writable => true},
        :physical_addresses_country_or_region => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:CountryOrRegion', :writable => true},
